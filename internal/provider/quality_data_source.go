...
func findQuality(name string, s []*radarr.QualityDefinitionResource) (*radarr.QualityDefinitionResource, error) {
	for _, p := range s {
...
func (q *Quality) writeFromDefinition(quality *radarr.QualityDefinitionResource) {
