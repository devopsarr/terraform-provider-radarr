		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.radarr_auto_tags.test", "auto_tags.*", map[string]string{"remove_tags_automatically": "true"}),
				),
			},
		},
	})
