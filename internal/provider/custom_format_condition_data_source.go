...
func (s *CustomFormatCondition) write(spec *radarr.CustomFormatSpecificationSchema) {
...
func (s *CustomFormatCondition) writeFields(fields []*radarr.Field) {
...
func (s *CustomFormatCondition) read() *radarr.CustomFormatSpecificationSchema {
...
func (s *CustomFormatCondition) readFields() []*radarr.Field {
