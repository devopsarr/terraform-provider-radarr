...
func (c *DownloadClientConfig) write(downloadClientConfig *radarr.DownloadClientConfig) {
	...
	c.CheckForFinishedDownloadInterval = types.Int64Value(downloadClientConfig.CheckForFinishedDownloadInterval)
...
func (c *DownloadClientConfig) read() *radarr.DownloadClientConfig {
	return &radarr.DownloadClientConfig{
		...
		CheckForFinishedDownloadInterval: c.CheckForFinishedDownloadInterval.ValueInt64(),
		ID:                               c.ID.ValueInt64(),
