		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.radarr_notifications.test", "notifications.*", map[string]string{"path": "/scripts/test.sh"}),
				),
			},
		},
	})
...
data "radarr_notifications" "test" {
}
`
