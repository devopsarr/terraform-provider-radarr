		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.radarr_quality_definitions.test", "quality_definitions.*", map[string]string{"id": "21"}),
				),
			},
		},
	})
...
data "radarr_quality_definitions" "test" {
}
`
