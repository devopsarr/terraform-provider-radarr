...
func (d *DownloadClientTransmission) write(ctx context.Context, downloadClient *radarr.DownloadClientOutput) {
...
func (d *DownloadClientTransmission) read(ctx context.Context) *radarr.DownloadClientInput {
	var tags []int
