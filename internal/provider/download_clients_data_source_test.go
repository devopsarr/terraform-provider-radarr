		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.radarr_download_clients.test", "download_clients.*", map[string]string{"port": "9091"}),
				),
			},
		},
	})
...
data "radarr_download_clients" "test" {
}
`
