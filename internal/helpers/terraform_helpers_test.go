...
func TestDataSourceConfigure(t *testing.T) {
	...
	diags.AddError("Unexpected DataSource Configure Type", "Expected *radarr.APIClient, got: string. Please report this issue to the provider developers.")
	...
	tests := map[string]struct {
		...
		"working": {
			expected: radarr.NewAPIClient(radarr.NewConfiguration()),
		},
		"nil": {
			expected: (*radarr.APIClient)(nil),
		},
		"error": {
			expected:    "abc",
			errorString: diags,
...
func TestResourceConfigure(t *testing.T) {
	...
	diags.AddError("Unexpected Resource Configure Type", "Expected *radarr.APIClient, got: string. Please report this issue to the provider developers.")
